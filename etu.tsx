...
// export function Chatbot({ ws, roomName }) {
...
//   const openChat = () => {
//     const newRoom = Date.now().toString();   // ✔ correct
//     setRoomName(newRoom);

//     const baseUrl = import.meta.env.VITE_WS_BASE_URL;
//     const wsUrl = `${baseUrl}/${newRoom}/`;

//     const socket = new WebSocket(wsUrl);     // ✔ créer la connexion
//     setWs(socket);
...
//       {/* fenêtre avant ouverture du chat */}
//       <AnimatePresence>
//         {open && !showChat && (
//           <motion.div 
//             initial={{ opacity: 0, scale: 0.9, y: 20 }}
...
//         {open && showChat && (
//           <div className="mt-4">
//             <Chatbot ws={ws} roomName={roomName} /> {/* ✔ correction */}
//           </div>
//         )}
//       </AnimatePresence>
//     </div>
