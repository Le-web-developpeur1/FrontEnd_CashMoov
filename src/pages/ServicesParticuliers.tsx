    ...
    return (
        <>
            <SEO
                ...
                description="Découvrez nos de transfert d'argent pour particuliers: transfert local et international, dépôt et retrait, paiement mobile, Rapide et sécurisé."
                keywords='transfert argent particuliers, mobile money guinée, envoi argent international, paiement mobile'
                url='https://cashmoov.net/services-particuliers'
            />
                                            ...
                                            if (typeof feature === 'object' && 'icon' in feature) {
                                                ...
                                                return (
                                                    <li key={idx} className="flex items-start gap-4">
                                                        <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#2A4793]/10 to-[#F7CE47]/10 flex items-center justify-center flex-shrink-0">
                                                            <FeatureIcon className="w-10 h-10 text-[#2A4793]" />
                                                        </div>
