                    ...
                    >
                        {stats.map((stat, index) => (
                            <motion.div
                                ...
                                className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 text-center border border-gray-200 hover:border-[#2A4793]/50 hover:shadow-lg transition-all duration-300"
                            >
                    ...
                    >
                        <div>
                            ...
                            <div className="space-y-4 text-gray-600 leading-relaxed">
                                <p>
                                    Cashmoov a réussi le pari de déployer une plateforme de mobile money qui tienne compte des besoins et des réalités des populations guinéennes et africaines.
                                </p>
                                <p>
                                    Forte de son ancrage local, l'entreprise se distingue par sa proximité avec les populations, la fiabilité de son réseau de distribution et sa capacité à traiter des transactions à volumes importants.
                                </p>
                                <p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <p className="text-gray-600 leading-relaxed mb-4">
                            Elle a ciblé dès ses premières heures la population active dans le but de faciliter le mouvement des capitaux et ainsi favoriser l'essor de plusieurs activités économiques.
                        </p>
                        <p className="text-gray-600 leading-relaxed">
                            Étant très sollicité pour les paiements de fournisseurs, de marchandises, l'entreprise a su s'adapter aux exigences de ce marché pour se positionner comme un acteur majeur dans le pays.
                        </p>
                    </motion.div>
                </div>
            </div>
                    ...
                    >
                        {values.map((value, index) => (
                            <motion.div
                                ...
                                variants={itemVariants}
                                whileHover={{ y: -5 }}
                                className="bg-white rounded-2xl p-6 border border-gray-200 hover:border-[#2A4793]/50 hover:shadow-lg transition-all duration-300"
                            >
