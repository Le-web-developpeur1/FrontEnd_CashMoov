...
export default function AboutPage() {
    ...
    return (
        <>
            <SEO
                title='A Propos'
                description="Cashmoov, leader du transfert d'argent ne Guinée. Découvez notre histoire, notre mission et nos valeurs."
                keywords='à propos cashmoov, histoire cashmoov, leader transfert guinée'
                url='https://cashmoov.net/about'
            />
            ...
            <section className="mt-10">
                ...
                <div className="py-12 sm:py-10 lg:py-16 bg-white">
