    ...
    return (
        <>
            <SEO
                ...
                description="Conditions générales du service cashmoov. Consultez les modalités et les conditions d'utilisations de notre service de monaie éléctronique."
                url="https://cashmoov.net/terms"
            />
