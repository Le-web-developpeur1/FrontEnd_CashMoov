    ...
    return (
        <>
            <SEO
                ...
                description="Solutions de paiement pour entreprises : paiement de salaires, cash collection, caisse déplacée. Simplifiez la gestion financière de votre entreprise."
                keywords='paiment salaire guinée, cash collection, services etreprises, gestion financière'
                url='https://cashmoov.net/services-entreprises'
            />
